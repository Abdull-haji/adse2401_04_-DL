...
========================================================================================
This program demonstrates how rainfall and temperature data can be used to predict maize yield using a
...
# # 1. Constants
# -------------------------------------------------------------------------
DATA_FILE = Path(r"C:\Users\LENOVO\Downloads\rainfall_temp_vs_yield.csv")

RESULTS_DIR = Path(r"C:\Users\LENOVO\Downloads\results")
RANDOM_STATE = 42
...
# # Columns in the rainfall_tem_vs_yield.csv file
...
def plot_residuals(
    ...
    plt.savefig(RESULTS_DIR / "residuals_distribution.png", dpi=300)
    plt.close()
